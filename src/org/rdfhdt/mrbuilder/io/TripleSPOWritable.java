...
public class TripleSPOWritable extends TripleWritable<LongWritable, LongWritable, LongWritable> {

    /**
     *
     */
    public TripleSPOWritable() {
	super(new LongWritable(), new LongWritable(), new LongWritable());
    }
}
