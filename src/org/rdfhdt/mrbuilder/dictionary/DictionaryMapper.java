...
//	if (triple.getObject().toString().toString().contains("Forest Green is an unincorporated community in southeastern Chariton County"))
//    	System.out.println("Mapper: " + triple.getObject().toString());
    }
}
