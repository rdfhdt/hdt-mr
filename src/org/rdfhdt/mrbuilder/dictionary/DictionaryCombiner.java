...
public class DictionaryCombiner extends Reducer<Text, Text, Text, Text> {
...
//	if (key.toString().toString().contains("Forest Green is an unincorporated community in southeastern Chariton County"))
